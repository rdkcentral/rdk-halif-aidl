...
class BnRingBufferSource : public ::android::BnInterface<IRingBufferSource> {
public:
  ...
  explicit BnRingBufferSource();
  ::android::status_t onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) override;
  int32_t getInterfaceVersion();
  std::string getInterfaceHash();
};  // class BnRingBufferSource

class IRingBufferSourceDelegator : public BnRingBufferSource {
public:
  explicit IRingBufferSourceDelegator(::android::sp<IRingBufferSource> &impl) : _aidl_delegate(impl) {}
  ...
  ::android::binder::Status release(const ::com::rdk::hal::ringbuffer::RingBufferAcquireResult::Id& id) override {
    return _aidl_delegate->release(id);
  }
  int32_t getInterfaceVersion() override {
    int32_t _delegator_ver = BnRingBufferSource::getInterfaceVersion();
...
private:
  ::android::sp<IRingBufferSource> _aidl_delegate;
};  // class IRingBufferSourceDelegator
}  // namespace ringbuffer
}  // namespace hal
}  // namespace rdk
}  // namespace com
