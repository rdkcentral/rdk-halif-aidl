...
interface IFilter {
     ...
     *
     * The sink will receive the data from the filter through the means provided
     * in the SoftwareSink return value. It will further provide callbacks in the
     * softwareSink parameter.
     *
     * @param[in] softwareSink A set of callbacks the sink wants to receive.
     * @returns The details the sink needs in order to actually be able to receive
     *     data.
     */
     ...
     *
     * The caller should remember to also close and dispose the shared memory,
     * file descriptor and message queue.
     *
     * @param[in] id The ID of the sink to be unregistered.
     * @returns True if a sink with the given ID existed and was removed, false
     *     otherwise.
     */
