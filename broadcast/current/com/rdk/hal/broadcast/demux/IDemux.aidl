...
interface IDemux {
     ...
     *
     * The client takes ownership of the returned object. Resources are only bound to the returned object; they are
     * released when the injector is no longer referenced.
     *
     * Only available when DemuxCapabilities.acceptsDataFromSoftware is true. The number of simultaneous injector
     * objects may be limited by the implementation.
     *
