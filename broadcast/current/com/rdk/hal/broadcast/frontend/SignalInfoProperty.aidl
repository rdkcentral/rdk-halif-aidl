 ...
 *
 * Note that this enum is shared across all frontend types and thus includes
 * values that are only usable on some of them. You should always request and
 * consult the list of supported status properties from the frontend before
 * using any of them.
 *
 * @author Jan Pedersen
