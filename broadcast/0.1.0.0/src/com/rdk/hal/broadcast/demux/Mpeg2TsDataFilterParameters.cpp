...
namespace broadcast {
namespace demux {
::android::status_t Mpeg2TsDataFilterParameters::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t Mpeg2TsDataFilterParameters::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
