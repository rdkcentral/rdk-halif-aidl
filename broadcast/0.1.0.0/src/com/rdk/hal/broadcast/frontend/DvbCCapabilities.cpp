...
namespace broadcast {
namespace frontend {
::android::status_t DvbCCapabilities::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readEnumVector(&dvbCAnnexes);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  if (_aidl_parcel->dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
...
::android::status_t DvbCCapabilities::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = _aidl_parcel->writeEnumVector(dvbCAnnexes);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
