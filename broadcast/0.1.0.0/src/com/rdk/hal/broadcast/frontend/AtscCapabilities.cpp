...
namespace broadcast {
namespace frontend {
::android::status_t AtscCapabilities::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t AtscCapabilities::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
