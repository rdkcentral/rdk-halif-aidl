...
cd ${DESTINATION_PATH}
# Specific file copies or sym links
if [ ! -f CHANGELOG.md ]; then
    print_info "${DESTINATION_PATH}/CHANGELOG.md : Created"
    # Create the sym link if it doesn't exist for the change log
    # Ideally generation of the next documentation and release should occur from either a release branch, or main after merge. 
