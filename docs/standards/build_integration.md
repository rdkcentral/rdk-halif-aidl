...
| [HAL Interface Usage](../key_concepts/hal/hal_interface_usage.md) | What a consumer compiles, and how far a middleware and a vendor pin may differ |
| [Versioning Guide](versioning-guide.md) | The version scheme, the era rules, and the `isCompatible()` predicate |
