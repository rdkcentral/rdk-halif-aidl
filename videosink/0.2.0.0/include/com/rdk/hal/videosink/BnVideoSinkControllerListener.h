...
namespace hal {
namespace videosink {
class BnVideoSinkControllerListener : public ::android::BnInterface<IVideoSinkControllerListener> {
public:
  ...
  explicit BnVideoSinkControllerListener();
  ::android::status_t onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) override;
  int32_t getInterfaceVersion();
  std::string getInterfaceHash();
};  // class BnVideoSinkControllerListener

class IVideoSinkControllerListenerDelegator : public BnVideoSinkControllerListener {
public:
  explicit IVideoSinkControllerListenerDelegator(::android::sp<IVideoSinkControllerListener> &impl) : _aidl_delegate(impl) {}
  ...
  ::android::binder::Status onStateChanged(::com::rdk::hal::videosink::State oldState, ::com::rdk::hal::videosink::State newState) override {
  ...
  int32_t getInterfaceVersion() override {
    int32_t _delegator_ver = BnVideoSinkControllerListener::getInterfaceVersion();
...
private:
  ::android::sp<IVideoSinkControllerListener> _aidl_delegate;
};  // class IVideoSinkControllerListenerDelegator
}  // namespace videosink
}  // namespace hal
}  // namespace rdk
}  // namespace com
