...
namespace rdk {
namespace hal {
::android::status_t PropertyValue::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t PropertyValue::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  auto _aidl_start_pos = _aidl_parcel->dataPosition();
  _aidl_parcel->writeInt32(0);
  _aidl_ret_status = _aidl_parcel->writeNullableParcelable(value);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
...
namespace rdk {
namespace hal {
::android::status_t PropertyValue::Value::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t PropertyValue::Value::writeToParcel(::android::Parcel* _aidl_parcel) const {
