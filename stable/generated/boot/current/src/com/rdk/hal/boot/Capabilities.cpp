...
::android::status_t Capabilities::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readEnumVector(&supportedBootReasons);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  if (_aidl_parcel->dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
  ...
  _aidl_ret_status = _aidl_parcel->readEnumVector(&supportedResetTypes);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  _aidl_parcel->setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
...
::android::status_t Capabilities::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = _aidl_parcel->writeEnumVector(supportedBootReasons);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  _aidl_ret_status = _aidl_parcel->writeEnumVector(supportedResetTypes);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
