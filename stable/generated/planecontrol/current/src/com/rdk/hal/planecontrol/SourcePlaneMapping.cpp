...
::android::status_t SourcePlaneMapping::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readInt32(&destinationPlaneIndex);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  _aidl_parcel->setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
...
::android::status_t SourcePlaneMapping::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = _aidl_parcel->writeInt32(destinationPlaneIndex);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
