...
namespace hal {
namespace drm {
::android::status_t HdcpLevels::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readInt32(reinterpret_cast<int32_t *>(&connectedLevel));
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  if (_aidl_parcel->dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
...
::android::status_t HdcpLevels::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  auto _aidl_start_pos = _aidl_parcel->dataPosition();
  _aidl_parcel->writeInt32(0);
  _aidl_ret_status = _aidl_parcel->writeInt32(static_cast<int32_t>(connectedLevel));
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
