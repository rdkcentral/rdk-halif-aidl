...
namespace hal {
namespace drm {
::android::status_t DrmMetricNamedValue::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t DrmMetricNamedValue::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
