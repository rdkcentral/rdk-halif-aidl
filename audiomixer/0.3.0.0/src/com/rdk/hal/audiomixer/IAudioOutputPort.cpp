...
::android::binder::Status BpAudioOutputPort::registerEventListener(const ::android::sp<::com::rdk::hal::audiomixer::IAudioOutputPortListener>& audioOutputPortEventListener, bool* _aidl_return) {
  ::android::Parcel _aidl_data;
  _aidl_data.markForBinder(remoteStrong());
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = _aidl_data.writeStrongBinder(audioOutputPortEventListener);
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  _aidl_ret_status = remote()->transact(BnAudioOutputPort::TRANSACTION_registerEventListener, _aidl_data, &_aidl_reply, 0);
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && IAudioOutputPort::getDefaultImpl())) {
     return IAudioOutputPort::getDefaultImpl()->registerEventListener(audioOutputPortEventListener, _aidl_return);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::binder::Status BpAudioOutputPort::unregisterEventListener(const ::android::sp<::com::rdk::hal::audiomixer::IAudioOutputPortListener>& audioOutputPortEventListener, bool* _aidl_return) {
  ::android::Parcel _aidl_data;
  _aidl_data.markForBinder(remoteStrong());
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = remote()->transact(BnAudioOutputPort::TRANSACTION_unregisterEventListener, _aidl_data, &_aidl_reply, 0);
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && IAudioOutputPort::getDefaultImpl())) {
     return IAudioOutputPort::getDefaultImpl()->unregisterEventListener(audioOutputPortEventListener, _aidl_return);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::status_t BnAudioOutputPort::onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) {
  ...
  break;
  case BnAudioOutputPort::TRANSACTION_registerEventListener:
  {
    ::android::sp<::com::rdk::hal::audiomixer::IAudioOutputPortListener> in_audioOutputPortEventListener;
    bool _aidl_return;
    if (!(_aidl_data.checkInterface(this))) {
      _aidl_ret_status = ::android::BAD_TYPE;
      break;
    }
    _aidl_ret_status = _aidl_data.readStrongBinder(&in_audioOutputPortEventListener);
    if (((_aidl_ret_status) != (::android::OK))) {
      break;
    }
    if (auto st = _aidl_data.enforceNoDataAvail(); !st.isOk()) {
    ...
    ::android::binder::Status _aidl_status(registerEventListener(in_audioOutputPortEventListener, &_aidl_return));
    _aidl_ret_status = _aidl_status.writeToParcel(_aidl_reply);
    if (((_aidl_ret_status) != (::android::OK))) {
      break;
    }
  ...
  break;
  case BnAudioOutputPort::TRANSACTION_unregisterEventListener:
  {
    ::android::sp<::com::rdk::hal::audiomixer::IAudioOutputPortListener> in_audioOutputPortEventListener;
    bool _aidl_return;
    if (!(_aidl_data.checkInterface(this))) {
    ...
    ::android::binder::Status _aidl_status(unregisterEventListener(in_audioOutputPortEventListener, &_aidl_return));
    _aidl_ret_status = _aidl_status.writeToParcel(_aidl_reply);
    if (((_aidl_ret_status) != (::android::OK))) {
      break;
    }
