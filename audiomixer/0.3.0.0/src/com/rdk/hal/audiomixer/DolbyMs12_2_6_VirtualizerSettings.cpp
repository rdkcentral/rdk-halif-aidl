...
::android::status_t DolbyMs12_2_6_VirtualizerSettings::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readInt32(&boost);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  _aidl_parcel->setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
...
::android::status_t DolbyMs12_2_6_VirtualizerSettings::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = _aidl_parcel->writeInt32(boost);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
