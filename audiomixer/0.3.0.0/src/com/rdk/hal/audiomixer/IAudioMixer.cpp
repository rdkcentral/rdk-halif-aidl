...
::android::binder::Status BpAudioMixer::registerEventListener(const ::android::sp<::com::rdk::hal::audiomixer::IAudioMixerEventListener>& audioMixerEventListener, bool* _aidl_return) {
  ::android::Parcel _aidl_data;
  _aidl_data.markForBinder(remoteStrong());
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = remote()->transact(BnAudioMixer::TRANSACTION_registerEventListener, _aidl_data, &_aidl_reply, 0);
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && IAudioMixer::getDefaultImpl())) {
     return IAudioMixer::getDefaultImpl()->registerEventListener(audioMixerEventListener, _aidl_return);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::binder::Status BpAudioMixer::unregisterEventListener(const ::android::sp<::com::rdk::hal::audiomixer::IAudioMixerEventListener>& audioMixerEventListener, bool* _aidl_return) {
  ::android::Parcel _aidl_data;
  _aidl_data.markForBinder(remoteStrong());
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = remote()->transact(BnAudioMixer::TRANSACTION_unregisterEventListener, _aidl_data, &_aidl_reply, 0);
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && IAudioMixer::getDefaultImpl())) {
     return IAudioMixer::getDefaultImpl()->unregisterEventListener(audioMixerEventListener, _aidl_return);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::status_t BnAudioMixer::onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) {
  ...
  break;
  case BnAudioMixer::TRANSACTION_registerEventListener:
  {
    ::android::sp<::com::rdk::hal::audiomixer::IAudioMixerEventListener> in_audioMixerEventListener;
    bool _aidl_return;
    if (!(_aidl_data.checkInterface(this))) {
    ...
    ::android::binder::Status _aidl_status(registerEventListener(in_audioMixerEventListener, &_aidl_return));
    _aidl_ret_status = _aidl_status.writeToParcel(_aidl_reply);
    if (((_aidl_ret_status) != (::android::OK))) {
      break;
    }
  ...
  break;
  case BnAudioMixer::TRANSACTION_unregisterEventListener:
  {
    ::android::sp<::com::rdk::hal::audiomixer::IAudioMixerEventListener> in_audioMixerEventListener;
    bool _aidl_return;
    if (!(_aidl_data.checkInterface(this))) {
    ...
    ::android::binder::Status _aidl_status(unregisterEventListener(in_audioMixerEventListener, &_aidl_return));
    _aidl_ret_status = _aidl_status.writeToParcel(_aidl_reply);
    if (((_aidl_ret_status) != (::android::OK))) {
      break;
    }
