...
::android::binder::Status BpAudioOutputPortController::getDolbyMs12_2_6_Dap(::android::sp<::com::rdk::hal::audiomixer::IDolbyMs12_2_6_Dap>* _aidl_return) {
  ::android::Parcel _aidl_data;
  _aidl_data.markForBinder(remoteStrong());
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = remote()->transact(BnAudioOutputPortController::TRANSACTION_getDolbyMs12_2_6_Dap, _aidl_data, &_aidl_reply, 0);
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && IAudioOutputPortController::getDefaultImpl())) {
     return IAudioOutputPortController::getDefaultImpl()->getDolbyMs12_2_6_Dap(_aidl_return);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::binder::Status BpAudioOutputPortController::getAudioCapture(const ::android::sp<::com::rdk::hal::audiomixer::IAudioCaptureListener>& audioCaptureListener, ::android::sp<::com::rdk::hal::audiomixer::IAudioCapture>* _aidl_return) {
  ::android::Parcel _aidl_data;
  _aidl_data.markForBinder(remoteStrong());
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = _aidl_data.writeStrongBinder(audioCaptureListener);
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  _aidl_ret_status = remote()->transact(BnAudioOutputPortController::TRANSACTION_getAudioCapture, _aidl_data, &_aidl_reply, 0);
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && IAudioOutputPortController::getDefaultImpl())) {
     return IAudioOutputPortController::getDefaultImpl()->getAudioCapture(audioCaptureListener, _aidl_return);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::status_t BnAudioOutputPortController::onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) {
  ...
  break;
  case BnAudioOutputPortController::TRANSACTION_getDolbyMs12_2_6_Dap:
  {
    ::android::sp<::com::rdk::hal::audiomixer::IDolbyMs12_2_6_Dap> _aidl_return;
    if (!(_aidl_data.checkInterface(this))) {
      _aidl_ret_status = ::android::BAD_TYPE;
      break;
    }
    ::android::binder::Status _aidl_status(getDolbyMs12_2_6_Dap(&_aidl_return));
    _aidl_ret_status = _aidl_status.writeToParcel(_aidl_reply);
    if (((_aidl_ret_status) != (::android::OK))) {
      break;
    }
  ...
  break;
  case BnAudioOutputPortController::TRANSACTION_getAudioCapture:
  {
    ::android::sp<::com::rdk::hal::audiomixer::IAudioCaptureListener> in_audioCaptureListener;
    ::android::sp<::com::rdk::hal::audiomixer::IAudioCapture> _aidl_return;
    if (!(_aidl_data.checkInterface(this))) {
      _aidl_ret_status = ::android::BAD_TYPE;
      break;
    }
    _aidl_ret_status = _aidl_data.readStrongBinder(&in_audioCaptureListener);
    if (((_aidl_ret_status) != (::android::OK))) {
      break;
    }
    if (auto st = _aidl_data.enforceNoDataAvail(); !st.isOk()) {
    ...
    ::android::binder::Status _aidl_status(getAudioCapture(in_audioCaptureListener, &_aidl_return));
    _aidl_ret_status = _aidl_status.writeToParcel(_aidl_reply);
    if (((_aidl_ret_status) != (::android::OK))) {
      break;
    }
