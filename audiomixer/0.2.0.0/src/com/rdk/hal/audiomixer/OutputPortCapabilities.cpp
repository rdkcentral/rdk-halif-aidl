...
::android::status_t OutputPortCapabilities::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readString16Vector(&dolbyMs12AudioProfiles);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  if (_aidl_parcel->dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
  ...
  _aidl_ret_status = _aidl_parcel->readBool(&supportsAudioCapture);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  _aidl_parcel->setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
...
::android::status_t OutputPortCapabilities::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = _aidl_parcel->writeString16Vector(dolbyMs12AudioProfiles);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  _aidl_ret_status = _aidl_parcel->writeBool(supportsAudioCapture);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
