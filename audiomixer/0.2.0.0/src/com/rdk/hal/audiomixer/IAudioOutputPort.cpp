...
::android::binder::Status BpAudioOutputPort::getDolbyMs12_2_6_Dap(::android::sp<::com::rdk::hal::audiomixer::IDolbyMs12_2_6_Dap>* _aidl_return) {
  ::android::Parcel _aidl_data;
  _aidl_data.markForBinder(remoteStrong());
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = remote()->transact(BnAudioOutputPort::TRANSACTION_getDolbyMs12_2_6_Dap, _aidl_data, &_aidl_reply, 0);
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && IAudioOutputPort::getDefaultImpl())) {
     return IAudioOutputPort::getDefaultImpl()->getDolbyMs12_2_6_Dap(_aidl_return);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::binder::Status BpAudioOutputPort::getAudioCapture(const ::android::sp<::com::rdk::hal::audiomixer::IAudioCaptureListener>& audioCaptureListener, ::android::sp<::com::rdk::hal::audiomixer::IAudioCapture>* _aidl_return) {
  ::android::Parcel _aidl_data;
  _aidl_data.markForBinder(remoteStrong());
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = remote()->transact(BnAudioOutputPort::TRANSACTION_getAudioCapture, _aidl_data, &_aidl_reply, 0);
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && IAudioOutputPort::getDefaultImpl())) {
     return IAudioOutputPort::getDefaultImpl()->getAudioCapture(audioCaptureListener, _aidl_return);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::status_t BnAudioOutputPort::onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) {
  ...
  break;
  case BnAudioOutputPort::TRANSACTION_getDolbyMs12_2_6_Dap:
  {
  ...
  break;
  case BnAudioOutputPort::TRANSACTION_getAudioCapture:
  {
