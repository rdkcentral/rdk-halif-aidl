...
public:
  ...
  static constexpr uint32_t TRANSACTION_getDolbyMs12_2_6_Dap = ::android::IBinder::FIRST_CALL_TRANSACTION + 7;
  static constexpr uint32_t TRANSACTION_getAudioCapture = ::android::IBinder::FIRST_CALL_TRANSACTION + 8;
