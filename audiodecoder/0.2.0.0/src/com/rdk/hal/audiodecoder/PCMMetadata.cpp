...
::android::status_t PCMMetadata::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readInt32(&numChannels);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  if (_aidl_parcel->dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
  ...
  _aidl_ret_status = _aidl_parcel->readEnumVector(&channelTypes);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  if (_aidl_parcel->dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
  ...
  _aidl_ret_status = _aidl_parcel->readBool(&planarFormat);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  if (_aidl_parcel->dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
...
::android::status_t PCMMetadata::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  auto _aidl_start_pos = _aidl_parcel->dataPosition();
  _aidl_parcel->writeInt32(0);
  _aidl_ret_status = _aidl_parcel->writeInt32(numChannels);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  _aidl_ret_status = _aidl_parcel->writeEnumVector(channelTypes);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  ...
  _aidl_ret_status = _aidl_parcel->writeBool(planarFormat);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
