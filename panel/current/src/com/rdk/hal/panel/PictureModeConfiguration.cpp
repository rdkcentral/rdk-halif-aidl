...
namespace hal {
namespace panel {
::android::status_t PictureModeConfiguration::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t PictureModeConfiguration::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
