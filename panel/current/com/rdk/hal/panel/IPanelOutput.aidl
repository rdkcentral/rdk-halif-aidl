...
import com.rdk.hal.panel.IPanelOutputListener;
...
interface IPanelOutput
{
     ...
     *
     * An `IPanelOutputListener` can only be registered once and will fail on subsequent
     * registration attempts.
     *
     * Listener registration is independent of open()/close() and does not require
     * exclusive control of the panel output.
     *
     * @param[in] listener      IPanelOutputListener interface.
     *
     * @returns boolean
     ...
     *
     * @see unregisterListener(), IPanelOutputListener
     */
    boolean registerListener(in IPanelOutputListener listener);

    /**
     * Unregisters a callback listener for events generated by the panel output.
     *
     * @param[in] listener      Reference to a previously registered IPanelOutputListener interface.
     *
     * @returns boolean
     ...
     * @exception binder::Status::Exception::EX_NULL_POINTER for a null object.
     *
     * @see registerListener(), IPanelOutputListener
     */
    boolean unregisterListener(in IPanelOutputListener listener);
