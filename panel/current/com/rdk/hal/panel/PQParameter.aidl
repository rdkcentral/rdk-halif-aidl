...
enum PQParameter
{
    ...
    // Valid gamma values are 1.80 to 2.60 (180 to 260 in hundreds units).
    GAMMA = 6,                      	//!< Picture parameter  is Gamma
    ...
    DYNAMIC_CONTRAST_LEVEL = 30,        //!< Picture parameter  is Dynamic contrast
    // 0..n (0=off, n=maximum level)
