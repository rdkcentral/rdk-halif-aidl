...
public:
  ...
  static constexpr uint32_t TRANSACTION_setFuelLevel = ::android::IBinder::FIRST_CALL_TRANSACTION + 10;
...
public:
  ...
  ::android::binder::Status setFuelLevel(float fuelLevel) override {
    return _aidl_delegate->setFuelLevel(fuelLevel);
  }
