...
::android::binder::Status BpMotionSensorEventListener::onEvent(const ::com::rdk::hal::sensor::motion::MotionEvent& event) {
  ...
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && IMotionSensorEventListener::getDefaultImpl())) {
     return IMotionSensorEventListener::getDefaultImpl()->onEvent(event);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::status_t BnMotionSensorEventListener::onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) {
  ...
  {
    ::com::rdk::hal::sensor::motion::MotionEvent in_event;
    ...
    ::android::binder::Status _aidl_status(onEvent(in_event));
  }
  break;
