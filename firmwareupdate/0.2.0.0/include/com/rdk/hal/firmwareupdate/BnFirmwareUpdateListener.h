...
class BnFirmwareUpdateListener : public ::android::BnInterface<IFirmwareUpdateListener> {
public:
  ...
  explicit BnFirmwareUpdateListener();
  ::android::status_t onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) override;
  int32_t getInterfaceVersion();
  std::string getInterfaceHash();
};  // class BnFirmwareUpdateListener

class IFirmwareUpdateListenerDelegator : public BnFirmwareUpdateListener {
public:
  explicit IFirmwareUpdateListenerDelegator(::android::sp<IFirmwareUpdateListener> &impl) : _aidl_delegate(impl) {}
  ...
  int32_t getInterfaceVersion() override {
    int32_t _delegator_ver = BnFirmwareUpdateListener::getInterfaceVersion();
...
private:
  ::android::sp<IFirmwareUpdateListener> _aidl_delegate;
};  // class IFirmwareUpdateListenerDelegator
}  // namespace firmwareupdate
}  // namespace hal
}  // namespace rdk
}  // namespace com
