...
/** 
 *  @brief     Events callbacks listener interface from DRM.
 *  @author    TBD
 */

@VintfStability
oneway interface IDrmEventListener {

    /**
     * @brief Callback when the DRM resource has raised an error.
     *
    ...
    /**
     * @brief Callback when the DRM resource has transitioned to a new state.
     *
