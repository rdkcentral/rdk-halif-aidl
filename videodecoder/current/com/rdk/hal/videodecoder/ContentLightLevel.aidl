 ...
 *  Both fields are integer cd/m² (nits) in the range 0–65535.
...
parcelable ContentLightLevel {
     ...
     * in integer cd/m² (nits). Range: 0–65535. 0 = not present.
     ...
     * content, in integer cd/m² (nits). Range: 0–65535. 0 = not present.
