...
/**
 *  @brief     Optional push of events from one source.
 */
@VintfStability
oneway interface IMetricsSourceEventListener
{
     ...
     *
     *  The event is also placed in the source's buffer — the buffer, not this
     *  callback, is the delivery of record, so a listener that misses a call
     *  loses nothing.
     *
