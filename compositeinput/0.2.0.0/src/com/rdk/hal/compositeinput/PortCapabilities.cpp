...
::android::status_t PortCapabilities::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t PortCapabilities::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
