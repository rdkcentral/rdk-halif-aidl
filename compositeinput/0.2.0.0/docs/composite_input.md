...
Video scaling, positioning, and aspect-ratio control are handled separately by the [Plane Control](../planecontrol/plane_control.md) HAL. Audio routing (if supported) is handled by the platform's audio subsystem.
...
!!! info "References"
    |||
    |-|-|
    | **Interface Definition**     | [compositeinput](https://github.com/rdkcentral/rdk-halif-aidl/tree/main/compositeinput/0.2.0.0/com/rdk/hal/compositeinput) |
...
!!! tip "Related Pages"
    ...
    - [HDMI Input](../hdmiinput/hdmi_input.md)
