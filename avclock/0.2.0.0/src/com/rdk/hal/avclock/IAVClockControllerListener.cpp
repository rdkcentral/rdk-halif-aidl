...
::android::binder::Status BpAVClockControllerListener::onStateChanged(::com::rdk::hal::avclock::State oldState, ::com::rdk::hal::avclock::State newState) {
...
::android::status_t BnAVClockControllerListener::onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) {
  ...
  {
    ::com::rdk::hal::avclock::State in_oldState;
    ::com::rdk::hal::avclock::State in_newState;
