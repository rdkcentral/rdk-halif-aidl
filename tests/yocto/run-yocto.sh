...
#** ******************************************************************************
#
# run-yocto.sh - emulate a Yocto/BitBake build of the HAL libraries
...
WORK="$(mktemp -d "${TMPDIR:-/tmp}/yocto.XXXXXX")"
...
echo "========================================="
echo "  yocto: offline production-build test"
echo "  work dir: ${WORK}"
echo "========================================="
...
echo ""
echo "========================================="
echo "✅ yocto: production build + install OK (${INSTALLED} HAL libraries)"
echo "========================================="
