...
#include <com/rdk/hal/audiosink/State.h>
#include <cstdint>
...
class IAudioSinkControllerListenerDefault : public IAudioSinkControllerListener {
public:
...
};  // class IAudioSinkControllerListenerDefault
}  // namespace audiosink
}  // namespace hal
}  // namespace rdk
}  // namespace com
