...
namespace hal {
namespace audiosink {
class BnAudioSinkEventListener : public ::android::BnInterface<IAudioSinkEventListener> {
public:
  ...
  explicit BnAudioSinkEventListener();
  ::android::status_t onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) override;
  int32_t getInterfaceVersion();
  std::string getInterfaceHash();
};  // class BnAudioSinkEventListener

class IAudioSinkEventListenerDelegator : public BnAudioSinkEventListener {
public:
  explicit IAudioSinkEventListenerDelegator(::android::sp<IAudioSinkEventListener> &impl) : _aidl_delegate(impl) {}

  ::android::binder::Status onStateChanged(::com::rdk::hal::audiosink::State oldState, ::com::rdk::hal::audiosink::State newState) override {
  ...
  int32_t getInterfaceVersion() override {
    int32_t _delegator_ver = BnAudioSinkEventListener::getInterfaceVersion();
...
private:
  ::android::sp<IAudioSinkEventListener> _aidl_delegate;
};  // class IAudioSinkEventListenerDelegator
}  // namespace audiosink
}  // namespace hal
}  // namespace rdk
}  // namespace com
