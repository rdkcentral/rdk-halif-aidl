...
flowchart TD
    ...
    ICaptureControllerListener["ICaptureControllerListener"]
    ICaptureEventListener["ICaptureEventListener"]
    ...
    ICaptureControllerListener --> RDKClientComponent
    ICaptureEventListener --> RDKClientComponent
    ...
    %% --- Wrapped Connections in a Subgraph ---
        ...
        ICapture --> ICaptureEventListener
        ICaptureController --> ICaptureControllerListener
    ...
    ICaptureControllerListener:::wheat
    ICaptureEventListener:::wheat
    VideoPlane0:::green
    VideoPlane1:::green
    VideoPlane2:::green
    VideoPlane3:::green
