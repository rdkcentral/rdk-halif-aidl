...
::android::binder::Status BpGraphicsFbProviderListener::onGraphicsFbReleased(int32_t oldGraphicsFbId, int64_t timestampNs) {
  ...
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && IGraphicsFbProviderListener::getDefaultImpl())) {
     return IGraphicsFbProviderListener::getDefaultImpl()->onGraphicsFbReleased(oldGraphicsFbId, timestampNs);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
...
::android::status_t BnGraphicsFbProviderListener::onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) {
  ...
  case BnGraphicsFbProviderListener::TRANSACTION_onGraphicsFbReleased:
  {
    ...
    ::android::binder::Status _aidl_status(onGraphicsFbReleased(in_oldGraphicsFbId, in_timestampNs));
  }
  break;
